    ...
    selectSlot: function(index) {
        ...
        if (this.els.btnCharSelectAction) {
            if (save) {
                ...
                if(this.els.btnCharDeleteAction) { this.els.btnCharDeleteAction.classList.remove('hidden'); this.els.btnCharDeleteAction.style.display = 'flex'; }
            } else {
                ...
                if(this.els.btnCharDeleteAction) { this.els.btnCharDeleteAction.classList.add('hidden'); this.els.btnCharDeleteAction.style.display = 'none'; }
            }
        }
    },
