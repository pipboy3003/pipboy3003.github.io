const UI = {
    ...
    init: function() {
        ...
        window.addEventListener('keydown', (e) => {
            ...
            // COMBAT STEUERUNG
            if (Game.state.view === 'combat' && typeof Combat !== 'undefined') {
    ...
    update: function() { 
        ...
        if(this.els.name && typeof Network !== 'undefined') {
            ...
            this.els.name.textContent = (Network.myId || "SURVIVOR") + sectorStr;
        }
