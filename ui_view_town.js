// [TIMESTAMP] 2026-01-10 21:00:00 - ui_view_town.js - Rusty Springs Safe + Vault + Combat
...
Object.assign(UI, {
    ...
    // ==========================================
    // === VAULT 101 (HOME BASE) ===
    // [NEU] Hier sind deine Minigame Buttons!
    // ==========================================
    ...
    // ==========================================
    // === COMBAT SCREEN ===
    // [NEU] Damit das Spiel nicht crasht
    // ==========================================
    ...
    renderShop: function(mode = 'buy') {
        ...
        const maxSlots = 20; // Hardcoded default, since Game.getMaxSlots might be missing
