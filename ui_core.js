window.UI = {
    ...
    updateTimer: function() { 
        ...
        if(this.els.gameScreen && !this.els.gameScreen.classList.contains('hidden')) {
            if(Date.now() - this.lastInputTime > 300000) { if(this.logout) this.logout("AFK: ZEITÜBERSCHREITUNG"); return; }
        }
